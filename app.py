...
def fetch_news_poster(poster_link):
    try:
        if poster_link and poster_link.strip() != "":
        ...
        fallback = Image.open('./Meta/no_image.jpg')
...
def display_news(list_of_news, news_quantity):
    ...
    for news in list_of_news:
        ...
        image_url = news_data.top_image if hasattr(news_data, 'top_image') and news_data.top_image else None
